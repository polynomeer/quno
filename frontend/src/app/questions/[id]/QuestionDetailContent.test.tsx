...
describe("QuestionDetailContent", () => {
  ...
  it("shows an error message when the question fails to load", () => {
    vi.mocked(useSession).mockReturnValue({ data: undefined, isLoading: false } as ReturnType<typeof useSession>);
    vi.mocked(useQuestion).mockReturnValue({ data: undefined, isLoading: false, isError: true } as unknown as ReturnType<typeof useQuestion>);
