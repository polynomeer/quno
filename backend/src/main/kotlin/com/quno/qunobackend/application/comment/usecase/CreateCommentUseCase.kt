...
class CreateCommentUseCase(
    ...
    fun execute(command: CreateCommentCommand): CommentResult {
        ...
        val saved = commentRepository.save(
            Comment.write(command.targetType, command.targetId, command.authorId, command.body),
        )
        ...
        outboxEventRepository.save(
            OutboxEvent.create(
                ...
                payload = """{"commentId":${saved.id},"actorId":${command.authorId},"questionAuthorId":${target.questionAuthorId},"answerAuthorId":${target.answerAuthorId ?: "null"}}""",
            ),
        )
