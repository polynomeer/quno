...
class QuestionVersionRepositoryAdapter(
    ...
    override fun findByQuestionIdAndVersionNumber(questionId: Long, versionNumber: Int): QuestionVersion? = jpaRepository.findByQuestionIdAndVersionNumber(questionId, versionNumber)?.toDomain()
