...
class FlowRepositoryAdapter(
    ...
    override fun findRecentlyReopenedQuestionIds(limit: Int): List<Long> = jpaRepository.findRecentlyReopenedQuestionIds(limit)

    override fun findRecentlySuperAnsweredClusterIds(limit: Int): List<Long> = jpaRepository.findRecentlySuperAnsweredClusterIds(limit)
}
